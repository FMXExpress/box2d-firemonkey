...
function TMobileBalanced.AddNode(parent: Tb2Body; const localAnchor: TVector2; depth: Integer; offset, a: PhysicsFloat): Tb2Body;
var
...
begin
   ...
   shape := Tb2PolygonShape.Create;
   shape.SetAsBox(offset, 0.25 * a, MakeVector(0.0, -a), 0.0);
   body.CreateFixture(shape, density);
...
initialization
   RegisterTestEntry('Mobile Balanced', TMobileBalanced);
