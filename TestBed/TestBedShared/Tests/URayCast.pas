...
begin
   ...
   begin
      ...
      begin
//         m_debugDrawerOpenGL.DrawPoint(callback1.m_point, 5.0, color1);
         m_debugDrawer.DrawPoint(callback1.m_point, 5.0, color1);

//         m_debugDraw.DrawSegment(point1, callback1.m_point, color2);
         m_world.Draw.DrawSegment(point1, callback1.m_point, color2);

         {$IFDEF OP_OVERLOAD}
//         m_debugDraw.DrawSegment(callback1.m_point, callback1.m_point +
         m_world.Draw.DrawSegment(callback1.m_point, callback1.m_point +
...
//            Multiply(callback1.m_normal, 0.5)), color3);
         m_world.Draw.DrawSegment(callback1.m_point, Add(callback1.m_point,
            Multiply(callback1.m_normal, 0.5)), color3);
...
//         m_debugDraw.DrawSegment(point1, point2, color2);
         m_world.Draw.DrawSegment(point1, point2, color2);
   ...
   begin
      ...
      begin
//         m_debugDrawerOpenGL.DrawPoint(callback2.m_point, 5.0, color1);
         m_debugDrawer.DrawPoint(callback2.m_point, 5.0, color1);

//         m_debugDraw.DrawSegment(point1, callback2.m_point, color2);
         m_world.Draw.DrawSegment(point1, callback2.m_point, color2);

         {$IFDEF OP_OVERLOAD}
//         m_debugDraw.DrawSegment(callback2.m_point, callback2.m_point +
//            0.5 * callback2.m_normal, color3);
         m_world.Draw.DrawSegment(callback2.m_point, callback2.m_point +
            0.5 * callback2.m_normal, color3);
         {$ELSE}
//         m_debugDraw.DrawSegment(callback2.m_point, Add(callback2.m_point,
//            Multiply(callback2.m_normal, 0.5)), color3);
         m_world.Draw.DrawSegment(callback2.m_point, Add(callback2.m_point,
            Multiply(callback2.m_normal, 0.5)), color3);
...
//         m_debugDrawerOpenGL.DrawPoint(p, 5.0, color1);
         m_debugDrawer.DrawPoint(p, 5.0, color1);

//         m_debugDraw.DrawSegment(point1, p, color2);
         m_world.Draw.DrawSegment(point1, p, color2);

         {$IFDEF OP_OVERLOAD}
//         m_debugDraw.DrawSegment(p, p + 0.5 * n, color3);
         m_world.Draw.DrawSegment(p, p + 0.5 * n, color3);
         {$ELSE}
//         m_debugDraw.DrawSegment(p, Add(p, Multiply(n, 0.5)), color3);
         m_world.Draw.DrawSegment(p, Add(p, Multiply(n, 0.5)), color3);
