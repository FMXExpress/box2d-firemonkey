...
//      m_debugDrawerOpenGL.DrawAABB(actor^.aabb, color);
      m_debugDrawer.DrawAABB(actor^.aabb, color);
   end;

//   m_debugDrawerOpenGL.DrawAABB(m_queryAABB, c_color2);
   m_debugDrawer.DrawAABB(m_queryAABB, c_color2);

//   m_debugDraw.DrawSegment(m_rayCastInput.p1, m_rayCastInput.p2, c_color2);
   m_world.Draw.DrawSegment(m_rayCastInput.p1, m_rayCastInput.p2, c_color2);

//   m_debugDrawerOpenGL.DrawPoint(m_rayCastInput.p1, 6.0, c_color3);
   m_debugDrawer.DrawPoint(m_rayCastInput.p1, 6.0, c_color3);

//   m_debugDrawerOpenGL.DrawPoint(m_rayCastInput.p2, 6.0, c_color4);
   m_debugDrawer.DrawPoint(m_rayCastInput.p2, 6.0, c_color4);

   if Assigned(m_rayActor) then
      {$IFDEF OP_OVERLOAD}
//      m_debugDrawerOpenGL.DrawPoint(m_rayCastInput.p1 + m_rayActor.fraction *
//         (m_rayCastInput.p2 - m_rayCastInput.p1), 6.0, c_color5);
      m_debugDrawer.DrawPoint(m_rayCastInput.p1 + m_rayActor.fraction *
         (m_rayCastInput.p2 - m_rayCastInput.p1), 6.0, c_color5);
...
//         m_rayCastInput.p1), m_rayActor.fraction)), 6.0, c_color5);
      m_debugDrawer.DrawPoint(Add(m_rayCastInput.p1, Multiply(Subtract(m_rayCastInput.p2,
         m_rayCastInput.p1), m_rayActor.fraction)), 6.0, c_color5);
      {$ENDIF}
