...
// call to "ReserView" removed as the view is already reset in the "ChangeTest"
//   if Assigned(TesterForm) then
//     TesterForm.ResetView;
...
//   m_debugDraw.DrawPolygon(vertices, m_shapeA.m_count, clVertices);
   m_world.Draw.DrawPolygon(vertices, m_shapeA.m_count, clVertices);
...
//   m_debugDraw.DrawPolygon(vertices, m_shapeB.m_count, clVertices2);
   m_world.Draw.DrawPolygon(vertices, m_shapeB.m_count, clVertices2);
...
//   m_debugDraw.DrawPolygon(vertices, m_shapeB.m_count, clVertices3);
   m_world.Draw.DrawPolygon(vertices, m_shapeB.m_count, clVertices3);
...
//   m_debugDraw.DrawPolygon(vertices, m_shapeB.m_count, clVertices4);
   m_world.Draw.DrawPolygon(vertices, m_shapeB.m_count, clVertices4);
