program TestBed_FM_Mobile;

uses
  System.StartUpCopy,
  FMX.MobilePreview,
  FMX.Forms,
  uFormDBox2DTestBedM in 'uFormDBox2DTestBedM.pas' {FormDBox2DTestBedM},
  ...
  uFormDumpM in 'uFormDumpM.pas' {FormDump};

{$R *.res}

begin
  Application.Initialize;
  Application.CreateForm(TFormDBox2DTestBedM, FormDBox2DTestBedM);
