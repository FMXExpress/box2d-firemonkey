...
procedure TFormPingPong.EditBTNClick(Sender: TObject);
begin
...
procedure TFormPingPong.FormShow(Sender: TObject);
begin
if not FGameLoaded then
...
procedure TFormPingPong.InitTimerTimer(Sender: TObject);
begin
  ...
  15, //DefaultBallRadius
  Trunc(pntbxGame.Width), //MapWidth
  Trunc(pntbxGame.Height), //MapHeight
  40, //BlockWidth
  20, //BlockHeight
  50 //BlockMinTop
  );
...
begin
  ...
  if pnlBottom.Visible <> Editing then
    pnlBottom.Visible := Editing;
...
begin
  ...
  begin
    GameState := gsPlaying;
    btnPauseResume.Text := 'Pause';
    btnPauseResume.StyleLookup := 'pausetoolbutton';
  end
  else
  begin
    GameState := gsPaused;
    btnPauseResume.Text := 'Resume';
    btnPauseResume.StyleLookup := 'playtoolbutton';
  end;
